...
const HotelInfo = ({ route: { params }, navigation: { goBack ,navigate} }) => {
  ...
  var [defaultInput, setDefaultInput] = useState(combinedString);
    ...
    // console.log(Object.keys(hotelInfoRes).length,"hjhjjhjj")
    // console.log(fetchingHotelInfo,"fetchingHotelInfo")
    return (
        // isLoading?<View style={{flex:1,alignItems:'center',justifyContent:'center'}}><ProgressBar/></View>:<View style={styles.mainContainer}>
        //     {
        //         fetchingHotelInfo&& Object.keys(hotelInfoRes).length>0 ? <View style={styles.progessBarContainer}><ProgressBar /></View> :
        //             <View style={{ flex: 1 }}>
...
fetchingHotelInfo?<View style={{flex:1,alignItems:'center',justifyContent:'center'}}><ProgressBar/></View>
            :
