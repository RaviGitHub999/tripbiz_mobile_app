...
const FlightBooking = ({navigation: {navigate}}) => {
  ...
  const handleSeatSelectionPopUp = () => {
    ...
    var selectedSeats = bookingFlight[bookIndex].seats.map((seg, sg) => {
  ...
  return (
    ...
    flightBookDataLoading || isLoading ? (
      ...
      <View style={{flex: 1}}>
        ...
        <ScrollView
          ...
          {bookingFlight.length > 1 ? (
            <View style={styles.flightResultsNavMainContainer}>
              <TouchableOpacity
                style={[
                  styles.flightResultsNavItem,
                  bookIndex === 0 && styles.flightResultsNavSelectedItem,
                ]}
                onPress={() => changeBookIndex(0)}>
                <Text
                  style={[
                    styles.flightResultsNavItemText,
                    bookIndex === 0 && styles.flightResultsNavSelectedItemText,
                  ]}>{`${bookingFlight[0]?.flightNew?.segments[0]?.originAirportCode}`}</Text>
                <IconSwitcher
                  componentName="AntDesign"
                  iconName="arrowright"
                  iconsize={3}
                  color={bookIndex === 0 ? colors.white : colors.black}
                />
                <Text
                  style={[
                    styles.flightResultsNavItemText,
                    bookIndex === 0 && styles.flightResultsNavSelectedItemText,
                  ]}>{`${bookingFlight[0]?.flightNew?.segments[0]?.destAirportCode}`}</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[
                  styles.flightResultsNavItem,
                  bookIndex === 1 && styles.flightResultsNavSelectedItem,
                ]}
                onPress={() => changeBookIndex(1)}>
                <Text
                  style={[
                    styles.flightResultsNavItemText,
                    bookIndex === 1 && styles.flightResultsNavSelectedItemText,
                  ]}>{`${bookingFlight[1]?.flightNew?.segments[0]?.originAirportCode}`}</Text>
                <IconSwitcher
                  componentName="AntDesign"
                  iconName="arrowright"
                  iconsize={3}
                  color={bookIndex === 1 ? colors.white : colors.black}
                />
                <Text
                  style={[
                    styles.flightResultsNavItemText,
                    bookIndex === 1 && styles.flightResultsNavSelectedItemText,
                  ]}>{`${bookingFlight[1]?.flightNew?.segments[0]?.destAirportCode}`}</Text>
              </TouchableOpacity>
            </View>
          ) : bookingFlight.length === 1 &&
            ...
            <View style={styles.flightResultsNavMainContainer}>
              <TouchableOpacity
                style={[
                  styles.flightResultsNavItem,
                  segIndex === 0 && styles.flightResultsNavSelectedItem,
                ]}
                onPress={() => setSegIndex(0)}>
                <Text
                  style={[
                    styles.flightResultsNavItemText,
                    segIndex === 0 && styles.flightResultsNavSelectedItemText,
                  ]}>{`${bookingFlight[0]?.flightNew?.segments[0]?.originAirportCode}`}</Text>
                <IconSwitcher
                  componentName="AntDesign"
                  iconName="arrowright"
                  iconsize={3}
                  color={segIndex === 0 ? colors.white : colors.black}
                />
                <Text
                  style={[
                    styles.flightResultsNavItemText,
              ...
              <TouchableOpacity
                style={[
                  styles.flightResultsNavItem,
                  segIndex === 1 && styles.flightResultsNavSelectedItem,
                ]}
                onPress={() => setSegIndex(1)}>
                <Text
                  style={[
                    styles.flightResultsNavItemText,
                    segIndex === 1 && styles.flightResultsNavSelectedItemText,
                  ]}>{`${bookingFlight[0]?.flightNew?.segments[1]?.originAirportCode}`}</Text>
                <IconSwitcher
                  componentName="AntDesign"
                  iconName="arrowright"
                  iconsize={3}
                  color={segIndex === 1 ? colors.white : colors.black}
                />
                <Text
                  style={[
                    styles.flightResultsNavItemText,
                    segIndex === 1 && styles.flightResultsNavSelectedItemText,
                  ]}>{`${bookingFlight[0]?.flightNew?.segments[1]?.destAirportCode}`}</Text>
              </TouchableOpacity>
            </View>
          ) : null}
          ...
          actions.validSeatMap(bookingFlight[bookIndex].seatData[segIndex]) ? (
            <View style={styles.seatSelectionBtnContainer}>
              ...
              <TouchableOpacity
                style={styles.seatSelectionBtn}
                onPress={handleSeatSelectionPopUp}>
            ...
            <View style={styles.baggageDetailsContainer}>
              ...
              <View style={styles.bookingFlightCabinAndCheckInContainer}>
                {bookingFlight[bookIndex].baggageDtls?.cabinBaggage ? (
                  <View style={styles.bookingFlightCabinAndCheckInSubContainer}>
                    <IconSwitcher
                      componentName="AntDesign"
                      iconName="arrowright"
                      color={colors.black}
                    ...
                    <Text style={styles.flightBaggageText}>
                      Cabin baggage:
                      <Text style={styles.flightBaggageDataText}>
                        {' '}
                        {bookingFlight[bookIndex].baggageDtls?.cabinBaggage}
                      </Text>
                    </Text>
                          ...
                          .map((rule, r) => {
                            if (rule.Type === 'Cancellation') {
                              return (
                                <View
                                  style={
                                    rule.From === null && {flexDirection: 'row'}
                                  }>
                                  <View
                                    style={
                                      styles.cancellationAndDateChangeDetailsEachContainer
                                    }
                                    key={r}>
                                    <IconSwitcher
                                      componentName="AntDesign"
                                    ...
                                    <Text
                                      style={
                                        styles.cancellationAndDateChangeDetailsEachContainerText
                                      }>
                                      {rule.To === null ||
                                      rule.From === null ||
                                      rule.Unit === null
            ...
            <Text style={styles.imp}>
              *Important{' '}
              <Text style={styles.note}>
                The airline fee is indicative. We do not guarantee the accuracy
                of this information. All fees mentioned are per passenger. Date
                change charges are applicable only on selecting the same airline
                on a new date. The difference in fares between the old and the
                new booking will also be payable by the user. If you require
                further information, please refer the Airline website for
                detailed fare rales for different fare types.
              </Text>
            </Text>
          </View>
        </ScrollView>
        <View style={styles.totalFareContainer}>
          <TouchableOpacity
            ...
            style={styles.totalFareToggleIconContainer}>
            <IconSwitcher
              componentName="Ionicons"
              iconName={isExpanded ? 'chevron-down-sharp' : 'chevron-up-sharp'}
              color={colors.black}
              iconsize={3}
            />
          </TouchableOpacity>
                ...
                {totalMealPrice ? (
                  <View style={styles.totalFareFlightEachChargeDetails}>
                    ...
                    <Text
                      style={
                        styles.ExcessBagCharges
                      }>{`+ ₹ ${totalMealPrice.toLocaleString('en-IN')}`}</Text>
                  </View>
                ) : null}
                {totalSeatCharges ? (
                  <View style={styles.totalFareFlightEachChargeDetails}>
        ...
        <Modal animationType="slide" visible={selectSeats}>
          <View
            style={{
              height: '100%',
              width: '100%',
                    ...
                    return (
                      <TouchableOpacity
                        style={
                          seatSegIdx === s
                            ? [
                                styles.flightBookSelectSeatsSegNavItem,
                                styles.flightBookSelectSeatsSegNavSelectedItem,
                              ]
                            : styles.flightBookSelectSeatsSegNavItem
                        }
                        onPress={() => setSeatSegIdx(s)}>
                        <Text
                          style={
                            seatSegIdx === s
                              ? [
                                  styles.flightBookSelectSeatsSegNavItemText,
                                  styles.flightBookSelectSeatsSegNavItemSelectedText,
                                ]
                              : styles.flightBookSelectSeatsSegNavItemText
                          }>{`${bookingFlight[bookIndex].flightNew.segments[segIndex].segRoutes[s]?.originCode} -> ${bookingFlight[bookIndex].flightNew.segments[segIndex].segRoutes[s]?.destCode}`}</Text>
                      </TouchableOpacity>
                    );
                  })}
                </View>
                ...
                <View style={styles.selectedSeatContainer}>
                  ...
                  <View style={{flexDirection: 'row'}}>
                    {Object.keys(
                      ...
                      return (
                        <Text style={styles.seatCode}>{`${seatCode}, `}</Text>
                      );
                    })}
                  </View>
                </View>
                    ...
                    return (
                      <>
                          ...
                          <View style={wingsStyles.emergencyExitMainContainer}>
                            <View style={wingsStyles.emergencyExitContainer}>
                              <IconSwitcher
                                ...
                                iconsize={3}
                              />
                              <Text style={wingsStyles.emergencyText}>
                                {' '}
                                Emergency exit
                              </Text>
                              <IconSwitcher
                        ...
                        <View>
                          ...
                          row.Seats &&
                          row.Seats[0] &&
                          wingPosArr[seatSegIdx].includes(
                            row.Seats[0].RowNo,
                          ) ? (
                            <View
                              style={
                                !actions.isExitRow(row)
                                  ? wingPosArr[seatSegIdx].indexOf(
                                    ...
                                    ? [
                                        wingsStyles.rightWing,
                                        wingsStyles.rightWingFirst,
                                      ]
                                    : wingPosArr[seatSegIdx].indexOf(
                                        row.Seats[0].RowNo,
                                      ) ===
                            ...
                            <FlatList
                              ...
                              renderItem={({item, index}) => (
                                <View
                                  ...
                                  <TouchableOpacity
                                    style={[
                                      wingsStyles.flightBookSeat,
                                      index % 6 === 2
                                        ? wingsStyles.spaceBetween
                                        : null,
                                      item.AvailablityType === 3
                                        ? wingsStyles.flightBookSeatReserved
                                    ...
                                    disabled={
                                      item.AvailablityType === 3 && true
                                    }
                                    onPress={
                                      !item.noSeat && item.AvailablityType === 1
                                        ? () => {
                                    ...
                                    <Text
                                      style={{fontSize: responsiveHeight(1.5)}}>
                                      {item.Code}
                                    </Text>
                                  </TouchableOpacity>
                                  {item.Price ? (
                              ...
                              style={
                                !actions.isExitRow(row)
                                  ? wingPosArr[seatSegIdx].indexOf(
                                    ...
                                    ? [
                                        wingsStyles.leftWing,
                                        wingsStyles.leftWingFirst,
                                      ]
                                    : wingPosArr[seatSegIdx].indexOf(
                                        row.Seats[0].RowNo,
                                      ) ===
        ...
        <Modal animationType="slide" transparent={true} visible={submitIsOpen}>
                    ...
                    <View style={styles.addingNewTripContainer}>
                      ...
                      <View style={styles.addingNewTripSubContainer}>
                        ...
                        <TouchableOpacity
                          ...
                          <Text style={styles.addingNewTripBtnText}>
                            Add to trip
                          </Text>
                        </TouchableOpacity>
                      </View>
        ...
        <PopUp
          value={fareIsOpen}
          handlePopUpClose={() => setFareIsOpen(false)}
          customStyles={{width: '100%'}}>
